...
def write_file(out_file_name, pose_arr):
    ...
    ----------
        outFile : str
            The file that will be written to! (Includes path from working dir)
        poseArr : PoseArray
...
def read_poses(in_file_name):
    """
        This reads information in from a PCD file and parses it into a poseArray that will
        ...
        ----------
            in_file_name : str
                ...
                and starts at the current working directory)
    """
    poses = PoseArray()
    ...
    while True:
        ...
        # x y z x.curvature y.curvature z.curvature w
        # 0 1 2 3           4           5           6
