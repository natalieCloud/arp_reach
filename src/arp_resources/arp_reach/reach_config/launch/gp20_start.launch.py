...
parameters = [
  {'name': 'robot_description_file',                'description': 'Path to the URDF/xacro file',                     'default': PathJoinSubstitution([FindPackageShare('arp_deployment_gp20'), 'model', 'reach_study', 'gp20_study.xacro'])},
  ...
  {'name': 'config_file',                           'description': 'Path to the reach study configuration YAML file', 'default': PathJoinSubstitution([FindPackageShare('reach_config'), 'config', 'posePath.yaml'])},
